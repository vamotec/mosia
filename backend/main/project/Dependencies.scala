...
object Dependencies {
  ...
  // for autoDataMeta
  val tika = "org.apache.tika" % "tika-core" % "3.2.2"
  ...
  val lombok = "org.projectlombok" % "lombok" % "1.18.40" % "provided"
  val flywayDp = "org.flywaydb" % "flyway-core" % "11.12.0"
  val flyPostgres = "org.flywaydb" % "flyway-database-postgresql" % "11.12.0"
  val gRpcScalapb =
