...
CODE_DIR="${PROJECT_ROOT}/src/agents"
...
# 主函数
main() {
    echo -e "${GREEN}🚀 Agents Proto 编译器 v1.0${NC}"
    ...
    echo -e "${YELLOW}   from agents.generated.client import AgentsClient${NC}"
    echo -e "${YELLOW}   async with AgentsClient() as client:${NC}"
